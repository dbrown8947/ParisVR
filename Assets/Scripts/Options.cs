...
public class Options : MonoBehaviour 
{
	...
	*/	
	void Start ()
	{
		...
		saveFolder.text = PlayerPrefs.GetString ("save", @"C:\Users\Capstone\Documents\MyObjects");
		assetFolder.text = PlayerPrefs.GetString ("asset", @"C:\Users\Capstone\Documents\MyObjects");
