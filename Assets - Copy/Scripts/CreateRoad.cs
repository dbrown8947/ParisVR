...
public class CreateRoad : MonoBehaviour
{
	...
	//Globals to alter CurveResolutions
	...
	/* 
    *  METHOD        : GetTangentPoints 
    * 
    *  DESCRIPTION   : This is used to update a quad's shape to match OSM xml data
    * 
    *  Parameters    : List<Vector3> Points: The list of points to create the roads
    *  
    *  Returns       : Vector3[] : The Updated mesh
    */
