/*  
*  FILE          : VRPlayerController.cs
*  PROJECT       : ParisVR
*  PROGRAMMER    : Dustin Brown
*  FIRST VERSION : 2018-03-01
*  DESCRIPTION   : 
*    Manages the player object and it's interactions while in VR mode
*/
...
/*
* Class Name	: VRPlayerController 
* Description   : Manages the player object and it's interactions while in VR mode
*/
public class VRPlayerController : MonoBehaviour
{
    ...
    */
	void VRControls ()
	{
		...
		//player is touching right touchpad, get axis to move camera 
	...
	/*   
	* 	Name		: CloseAllMenus
	*	Description : Closes All the UI Menus
