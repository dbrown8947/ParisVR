...
*    caluclations on the given points in order to draw water.
*/
...
public class LoadNatural : MonoBehaviour
{
    ...
    *  METHOD        : Awake 
    * 
    *  DESCRIPTION   : Get the location data for water from a given OSM xml file
    * 
    */
	private void Awake ()
	{
    ...
    *  METHOD        : Start 
    * 
    *  DESCRIPTION   : Instantiate the water object, calcualte catmull rom spline of given points, then update the mesh
    * 
    */
	void Start ()
	{
	...
	/* 
    *  METHOD        : ConvertToVector3List 
    * 
    *  DESCRIPTION   : This method is used to convert an OSMPosition node into a Vector3 for use in Unity
    *  
    *  PARAMETERS    : List<OSMPositionNode> listOfNodes : The OSMPosition nodes being converted to a list of Vector3s
    *  
    *  RETURNS       : List<Vector3> : The converted list
    * 
    */
	...
	/* 
    *  METHOD        : ConvertVector3ListToArray 
    * 
    *  DESCRIPTION   : This method is used to convert an list of vector3s into an array of vector3s for use in other methods
    *  
    *  PARAMETERS    : List<Vector3 listOfVectors : The Vector3s being converted to a list of Vector3s
    * 
    *  RETURNS       :  Vector3[] : The converted array 
    */
